define(['modules/mainApp', 'controllers/partials/navigator', 'controllers/singles/home', 'controllers/singles/blog', 'controllers/singles/blogPage', 'controllers/singles/about'], function (mainApp) {
    ...
    mainApp.config(function ($routeProvider, $locationProvider) {
        $routeProvider
            .when('/home', { templateUrl: 'App/html/singles/home.html', controller: 'homeController' })
            .when('/blog', { templateUrl: 'App/html/singles/blog.html', controller: 'blogController' })
            .when('/blogPage/:id', { templateUrl: 'App/html/singles/blogPage.html', controller: 'blogPageController' })
            .when('/about', { templateUrl: 'App/html/singles/about.html', controller: 'aboutController' })
